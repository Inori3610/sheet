        ...
        for customer in list:
            if customer.tenkhachhang == tenkhachhang:
                customer.tenkhachhang = (
                    new_data[0] if new_data[0] else customer.tenkhachhang
                )
                customer.loaiphong = new_data[1] if new_data[1] else customer.loaiphong
                customer.songay = (
                    new_data[2] if new_data[2] is not None else customer.songay
                )
                print(f"Updated {tenkhachhang} sucessfully")
                return
        ...
        match choice:
            ...
            case 3:
                if len(list) == 0:
                    ...
                    print(
                        "------------------THONG TIN KHACH HANG THUE PHONG-------------------"
                    )
            ...
            case 4:
                if len(list) == 0:
                    ...
                    print("Neu khong muon sua co the de blank >_o")
                    ...
                    so_ngay = input("Nhap so ngay thue moi: ")
                    if so_ngay.strip():
                        new_data.append(int(so_ngay))
                    else:
